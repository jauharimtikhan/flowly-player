...
const Rewind = createLucideIcon("rewind", __iconNode$b);
const __iconNode$a = [
...
const SlidersVertical = createLucideIcon("sliders-vertical", __iconNode$7);
const __iconNode$6 = [
...
const Volume1 = createLucideIcon("volume-1", __iconNode$4);
const __iconNode$3 = [
  [
    "path",
    {
...
const FREQUENCIES = [32, 64, 125, 250, 500, 1e3, 2e3, 4e3, 8e3, 16e3];
const DEFAULT_BANDS = FREQUENCIES.map((freq) => ({
  frequency: freq,
  label: freq >= 1e3 ? `${freq / 1e3}K` : `${freq}`,
  gain: 0
}));
...
function saveEqualizerState(bands, preset, enabled) {
  try {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        (showFallback || loading) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center bg-linear-to-br from-purple-500 to-pink-500", children: fallback ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-semibold text-xs", children: fallback.slice(0, 2).toUpperCase() }) : /* @__PURE__ */ jsxRuntimeExports.jsx(User, { size: 14, className: "text-white" }) })
      ]
    }
  );
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "titlebar", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tb-left", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tb-name", children: [
        "Flow",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { marginRight: 6 }, children: "ly" })
      ] }),
      youtubeAuth && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 ml-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { src: youtubeAuth.userAvatar, fallback: youtubeAuth.userName, className: "w-5 h-5" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-gray-400 max-w-17.5 truncate", children: youtubeAuth.userName }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tb-btns", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "tb-btn x", onClick: eAPI2.closeToTray, children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 12 }) })
    ] })
  ] });
};
const Tabs = ({ tab, setTab, playlist }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tabbar", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: cn("tab", tab === "player" && "active"), onClick: () => setTab("player"), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row justify-center items-center gap-x-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { size: 14 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Player" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: cn("tab", tab === "playlist" && "active"), onClick: () => setTab("playlist"), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-x-2 flex-row justify-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ListMusic, { size: 14 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Playlist" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "badge", children: playlist.length })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: cn("tab", tab === "equalizer" && "active"), onClick: () => setTab("equalizer"), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-x-2 flex-row justify-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SlidersVertical, { size: 14 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Equalizer" })
    ] }) })
  ] });
};
const PlayerPage = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("page", tab === "player" && "active"), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "scroll", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "tray-pill text-[10px]", children: "Background Mode" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 14, className: "animate-spin text-purple-400" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("status-dot", isPlaying && "on") })
          ] })
        ]
      }
    ),
    ytdlpStatus.error && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-red-300", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { size: 16 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: ytdlpStatus.error })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: async () => {
                ...
                const result = await eAPI2.downloadYtDlp();
                if (result.success) {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-row mb-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          className: "url-in",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "load-btn", onClick: loadSingle, disabled: isLoading || !ytdlpStatus.installed, children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 14, className: "animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { size: 14 }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "track-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "thumb", children: thumbId ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: `https://img.youtube.com/vi/${thumbId}/mqdefault.jpg`, alt: "thumb" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Music, { size: 28 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "track-meta", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "track-name", children: trackName }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "track-ch", children: trackChannel })
      ] }),
      trackPos && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "track-pos", children: trackPos })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "prog-wrap", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "prog-track", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "prog-fill", style: { width: `${progress}%` } }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "range",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "prog-times", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: curTime }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: durTime })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "controls", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "ctrl", onClick: prevTrack, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Rewind, { size: 18 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "ctrl play-ctrl", onClick: togglePlay, disabled: isLoading, children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 20, className: "animate-spin" }) : isPlaying ? /* @__PURE__ */ jsxRuntimeExports.jsx(Pause, { size: 20 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { size: 20 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "ctrl", onClick: nextTrack, children: /* @__PURE__ */ jsxRuntimeExports.jsx(FastForward, { size: 18 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mode-row", children: [
      { id: "normal", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { size: 16 }), label: "Normal" },
      { id: "auto", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FastForward, { size: 16 }), label: "Auto" },
      { id: "shuffle", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffle, { size: 16 }), label: "Shuffle" },
      { id: "loop", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { size: 16 }), label: "Loop" }
    ].map(({ id, icon, label }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        onClick: () => {
          setMode(id);
          toast(
            id === "normal" ? "▶ Normal mode" : id === "auto" ? "⏩ Auto-next aktif" : id === "shuffle" ? "⇄ Shuffle aktif" : "↻ Loop aktif"
          );
        },
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row items-center gap-x-1 justify-center", children: [
          icon,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "vol-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "vol-head", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "vol-label", children: "Volume" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "vol-val", children: [
          volume,
          "%"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "vol-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "mute-btn", onClick: toggleMute, children: /* @__PURE__ */ jsxRuntimeExports.jsx(VolumeIcon, { size: 18 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "range",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "quick-vols", children: [0, 25, 50, 75, 100].map((v) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "qv", onClick: () => applyVolume(v), children: [
        v,
        "%"
      ] }, v)) })
    ] })
...
const PlaylistPage = ({
  ...
  const handleKeyDownManual = (e) => {
    if (e.key === "Enter") handleManualAdd();
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("page", tab === "playlist" && "active"), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        youtubeAuth && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", style: { marginBottom: 12 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pl-add-title flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { size: 14 }),
                  " Cari di YouTube"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: searchResults.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    onClick: () => {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pl-add-row", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    className: "pl-url-in",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "pl-add-btn", onClick: handleSearch, disabled: isSearching, children: isSearching ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 14, className: "animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { size: 14 }) })
              ] }),
              searchResults.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    searchResults.map((result, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: result.thumb, className: "w-14 h-10 object-cover rounded", alt: result.title }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-white truncate", children: result.title }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] text-gray-400", children: result.channel })
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 12, className: "text-gray-400" })
                        ]
                      },
                      `${result.id}-${i}`
                    )),
                    isLoadingMore && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 16, className: "animate-spin mx-auto" })
                      }
                    )
                  ]
                }
        ...
        youtubeAuth && userPlaylists.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "pl-add-card",
            style: {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-1.5  max-h-40 overflow-y-auto", children: userPlaylists.map((pl) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] text-white truncate", children: pl.title })
                  ]
                },
                pl.id
              )) })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pl-add-card ", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pl-add-title", children: "Tambah Manual" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pl-add-row", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "pl-add-btn", onClick: handleManualAdd, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 14 }) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "pl-act-btn", onClick: plPlayAll, disabled: !ytdlpStatus.installed, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { size: 14 }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "pl-act-btn", onClick: plShuffleAll, disabled: !ytdlpStatus.installed, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffle, { size: 14 }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "pl-act-btn danger", onClick: plClear, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { size: 14 }) })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-h-52 overflow-y-auto", style: { scrollbarWidth: "thin" }, children: playlist.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Music, { size: 32, className: "mx-auto mb-2 opacity-50" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm", children: "Playlist kosong" })
            ]
          }
        ) : playlist.map((track, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pl-num", children: i === curIdx ? isPlaying ? "▶" : "⏸" : i + 1 }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pl-thumb", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: track.thumb, alt: track.title }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pl-info", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pl-item-title", children: track.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pl-item-sub", children: track.channel ?? track.id })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
...
function BandSlider({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: cn("text-[10px] font-mono", enabled ? "text-gray-300" : "text-gray-600"), children: [
      band.gain > 0 ? "+" : "",
      band.gain
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-28 w-5 flex items-center justify-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn("text-[9px] font-medium", enabled ? "text-gray-400" : "text-gray-600"), children: band.label })
  ] });
}
function EqualizerVisualizer({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("canvas", { ref: canvasRef, width: 380, height: 80, className: "w-full h-20 rounded-lg" });
}
const EqualizerPage = ({
  tab,
  eqEnabled,
  ...
  isPlaying,
  activePreset,
  EQUALIZER_PRESETS: EQUALIZER_PRESETS2,
  applyPreset,
  eqBands,
  updateBand
}) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("page", tab === "equalizer" && "active"), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "scroll overflow-auto max-h-150", style: { scrollbarWidth: "none" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", style: { marginBottom: 12 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SlidersVertical, { size: 18, className: "text-purple-400" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-base font-bold", children: "Equalizer" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-gray-500", children: "10-Band" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(EqualizerVisualizer, { audioEngine: audioEngineRef.current, isPlaying: isPlaying && eqEnabled }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: 6 }, className: "text-center  text-[10px] text-gray-500", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 12 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold text-gray-300", style: { marginBottom: 6 }, children: "Presets" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-1.5", children: EQUALIZER_PRESETS2.map((preset) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          className: cn(
            ...
            activePreset === preset.name ? "bg-purple-500/20 border-purple-500 text-purple-300" : "bg-gray-800 border-gray-700 text-gray-400 hover:bg-gray-700",
            !eqEnabled && "opacity-50 cursor-not-allowed"
          ),
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm", children: preset.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "truncate", children: preset.name })
          ]
        },
        preset.name
      )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold text-gray-300", style: { marginBottom: 8 }, children: "Frequency Bands" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-between items-end", children: eqBands.map((band, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(BandSlider, { band, onChange: (val) => updateBand(i, val), enabled: eqEnabled }, band.frequency)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-[9px] text-gray-500", style: { marginTop: 8 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Bass" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Mids" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Treble" })
          ] })
        ]
      }
    )
...
const FlowlyPlayer = () => {
  const audioCacheRef = reactExports.useRef(/* @__PURE__ */ new Map());
  ...
  const [volume, setVolumeState] = reactExports.useState(50);
  const [isMuted, setIsMuted] = reactExports.useState(false);
  const [progress, setProgress] = reactExports.useState(0);
  const [curTime, setCurTime] = reactExports.useState("0:00");
  const [durTime, setDurTime] = reactExports.useState("0:00");
  const [trackName, setTrackName] = reactExports.useState("Belum ada lagu");
  const [trackChannel, setTrackChannel] = reactExports.useState("— paste URL atau tambah ke playlist —");
  const [trackPos, setTrackPos] = reactExports.useState("");
  const [thumbId, setThumbId] = reactExports.useState(null);
  const [playlist, setPlaylist] = reactExports.useState([]);
  const [curIdx, setCurIdx] = reactExports.useState(-1);
  const [mode, setMode] = reactExports.useState("auto");
  const [shuffleHistory, setShuffleHistory] = reactExports.useState([]);
  const [singleUrl, setSingleUrl] = reactExports.useState("");
  const [plUrl, setPlUrl] = reactExports.useState("");
  ...
  const [__, setSaveLabel] = reactExports.useState("");
  const [youtubeAuth, setYoutubeAuth] = reactExports.useState(null);
  ...
  const [userPlaylists, setUserPlaylists] = reactExports.useState([]);
  const [_, setLoadingPlaylists] = reactExports.useState(false);
  const [nextPageToken, setNextPageToken] = reactExports.useState(null);
  const [hasMoreResults, setHasMoreResults] = reactExports.useState(false);
  const [isLoadingMore, setIsLoadingMore] = reactExports.useState(false);
  const searchContainerRef = reactExports.useRef(null);
  const [eqBands, setEqBands] = reactExports.useState(DEFAULT_BANDS);
  const [activePreset, setActivePreset] = reactExports.useState("Flat");
  const [eqEnabled, setEqEnabled] = reactExports.useState(true);
  const [ytdlpStatus, setYtdlpStatus] = reactExports.useState({
    installed: false,
    downloading: false
  });
  const modeRef = reactExports.useRef(mode);
  const curIdxRef = reactExports.useRef(curIdx);
  const playlistRef = reactExports.useRef(playlist);
  const shuffleHistoryRef = reactExports.useRef(shuffleHistory);
  const volumeRef = reactExports.useRef(volume);
  const eqBandsRef = reactExports.useRef(eqBands);
  const eqEnabledRef = reactExports.useRef(eqEnabled);
  const hasPrefetchedRef = reactExports.useRef(false);
  reactExports.useEffect(() => {
  ...
  const toast = reactExports.useCallback((msg) => {
    setToastMsg(msg);
    setToastVisible(true);
    if (toastTimerRef.current) clearTimeout(toastTimerRef.current);
    toastTimerRef.current = setTimeout(() => setToastVisible(false), 2500);
  }, []);
  const getOrFetchAudioInfo = reactExports.useCallback(async (videoId) => {
  ...
  const prefetchNextAudio = reactExports.useCallback(() => {
    ...
    const nextTrack2 = pl[nextIdx];
    const cache = audioCacheRef.current;
    if (cache.has(nextTrack2.id)) return;
    getOrFetchAudioInfo(nextTrack2.id).then((info) => {
  ...
  const playTrackByIndex = reactExports.useCallback(
    async (idx) => {
      ...
      try {
        ...
        setPlaylist(
          (prev) => prev.map(
            (t, i) => i === idx ? { ...t, title: audioInfo.title || t.title, channel: audioInfo.author || t.channel } : t
          )
        );
  ...
  const updateBand = reactExports.useCallback(
    (index, gain) => {
  ...
  const resetEqualizer = reactExports.useCallback(() => {
    setEqBands(DEFAULT_BANDS);
    setActivePreset("Flat");
    audioEngineRef.current?.resetEQ();
    toast("🔄 Equalizer direset");
  }, [toast]);
  const toggleEQ = reactExports.useCallback(() => {
    setEqEnabled((prev) => {
      const newValue = !prev;
      const engine = audioEngineRef.current;
      if (engine) {
  ...
  const handleYouTubeLogin = reactExports.useCallback(async () => {
    try {
      setIsLoggingIn(true);
      toast("⏳ Membuka login...");
  ...
  const fetchUserPlaylists = reactExports.useCallback(async (accessToken) => {
  ...
  const loadPlaylistItems = reactExports.useCallback(
    async (playlistId) => {
      ...
      try {
        ...
        const data = await response.json();
        if (data.items) {
          const tracks = data.items.filter((item) => item.snippet.resourceId.kind === "youtube#video").map((item) => ({
  ...
  const searchYouTube = reactExports.useCallback(
  ...
  const loadMoreResults = reactExports.useCallback(() => {
  ...
  const addSearchResultToPlaylist = reactExports.useCallback(
    (result) => {
      setPlaylist((prev) => {
  ...
  const playAt = reactExports.useCallback(
    (idx) => {
      setTab("player");
  ...
  const applyVolume = reactExports.useCallback((v) => {
  ...
  const seekTo = reactExports.useCallback((pct) => {
  ...
  const loadSingle = reactExports.useCallback(() => {
    ...
    setPlaylist((prev) => {
      ...
      const track = { id, title: id, channel: "", thumb: `https://img.youtube.com/vi/${id}/mqdefault.jpg` };
  ...
  const plAdd = reactExports.useCallback(() => {
    const ids = plUrl.split(",").map((s) => extractVideoId(s.trim())).filter(Boolean);
    if (ids.length === 0) {
      toast("⚠️ URL tidak valid");
      return;
    }
  ...
  const plRemove = reactExports.useCallback(
    (idx) => {
      setPlaylist((prev) => {
        const next = prev.filter((_2, i) => i !== idx);
  ...
  const plPlayAll = reactExports.useCallback(() => {
  ...
  const plShuffleAll = reactExports.useCallback(() => {
    if (!playlistRef.current.length) {
      toast("⚠️ Playlist kosong");
      return;
    }
  ...
  const plClear = reactExports.useCallback(() => {
    setPlaylist([]);
    setCurIdx(-1);
    setShuffleHistory([]);
    stopAll();
  ...
  reactExports.useEffect(() => {
    conveyorHooks.app.version().then(setAppversion).catch(() => {
    });
  }, [conveyorHooks]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed bottom-0.5 w-full left-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-[9px] text-gray-600", children: [
      "Flowly Player v",
      appVersion
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("toast", toastVisible && "show"), children: toastMsg })
  ] });
};
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(FlowlyPlayer, {});
}
ReactDOM.createRoot(document.getElementById("app")).render(/* @__PURE__ */ jsxRuntimeExports.jsx(App, {}));
